# Jan 18, 2023
# Samik Banerjee
# This unit-test code is for Nissl Cell-Detection BrightFeild -- Runs on GPU ID 0
...
# Ignore the Pre-processing step for tiles
# python3 ajay_nissl_dir_tiles.py <brainName> <inputLocationFolder> <fileExtension> 
...
for files in fileList1:
    ...
    if files not in fileList2:
        ...
        maskPath = os.path.join(filePath, 'mask')
        w, h, c = image.shape
        ...
        mask  = imread(os.path.join(maskPath, files.replace(fileExt, 'tif')))
